...
class PluginClassRenamer {
    ...
    private final String collocatePackageName;
    ...
    PluginClassRenamer(PointcutClass adviceClass) {
        ...
        collocatePackageName = rootPackageName + "/collocate/";
    }
    ...
    private boolean collocate(String internalName) {
        return internalName.startsWith(rootPackageName) && internalName.endsWith("Advice")
                || internalName.startsWith(collocatePackageName);
    }
